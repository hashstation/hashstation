...
namespace Config {
    ...
    std::string inTemplateFileDictRules =      "dict_rules_in";
    std::string inTemplateFileDictRulesAlt =   "dict_rules_alt_in";
    ...
    char * inTemplatePathDictRules = nullptr;
    char * inTemplatePathDictRulesAlt = nullptr;
    DB_APP * app = nullptr;
    int startTime = 0;
    int seqNo = 0;

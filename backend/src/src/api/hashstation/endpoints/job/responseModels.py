...
from src.api.hashstation.endpoints.batches.responseModels import batch_model
from src.api.hashstation.endpoints.dictionary.responseModels import dictionary_model
from src.api.hashstation.endpoints.pcfg.responseModels import pcfg_model
from src.api.hashstation.endpoints.markov.responseModels import hcStat_model
from src.api.hashstation.responseModels import pagination, simpleResponse, job_short_model, \
...
job_big_model = api.model('Job', {
    ...
    'workunit_sum_time': fields.Integer(),
    ...
    'fixed_workunit_size': fields.String(),
    'rule_application_mode': fields.Integer(),
})

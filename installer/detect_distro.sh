...
export DEFAULT_APACHE_USER
export DEFAULT_APACHE_CONFIG_DIR
export DEFAULT_APACHE_CONFIG_FILE
export DEFAULT_APACHE_DOCUMENT_ROOT
export DEFAULT_APACHE_SERVICE

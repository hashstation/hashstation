#!/usr/bin/env python3
#
# Updates the Hashstation's default user from environment values
...
wa_user = os.environ['HASHSTATION_USER']
wa_pw = os.environ['HASHSTATION_PW']
wa_email = os.environ['HASHSTATION_EMAIL']
...
try:
    ...
    if connection.is_connected():
        ...
        query = "UPDATE `hs_user` SET username='" + wa_user + "', password='" + pw_hash + "', mail='" + wa_email + "' WHERE id=1";
